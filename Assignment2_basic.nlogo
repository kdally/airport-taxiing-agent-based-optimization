...
to setup-roads
  let roads patches with [
    ...
    (((pxcor mod 5 = 0) or (pxcor = 0)) and (pycor >= -5) and (pycor <= 0)) or
    (((pxcor = -15) or (pxcor = 15)) and (pycor >= 0) and (pycor <= 5)) or
...
;; infrastructure 2 and 3 are connecting the roads to the runway. They are located at the top left and top right white intersections
  ask patches at-points [[15 0] [-15 0] ]
[sprout-infrastructures 1
[  set size 0.5
  set color grey
set patch-type "runwayconnection"
set heading 0]]
;; infrastructure 4 - 15 are on intersections of roads and get patch-type waypoint
  ask patches at-points [ [10 0] [5 0][0 0] [-5 0] [-10 0] [15 -5] [10 -5] [5 -5][0 -5] [-5 -5] [-10 -5] [-15 -5] ]
[sprout-infrastructures 1
[  set size 0.5
  set color grey
...
[  set size 0.5
  set color grey
  set heading 0]]
;; final agent goal: infrastructure 19. All infrastructure agents are instructed to go to this fictional end point. It could be regarded as: take-off to flight
...
to creating-links
ask infrastructures at-points [[15 0] [10 0] [5 0][0 0] [-5 0] [-10 0] [-15 0] [15 -5] [10 -5] [5 -5][0 -5] [-5 -5] [-10 -5] [-15 -5] ]  ;Create the links.
 [create-links-with other infrastructures in-radius 5 [ set weight 1 ] ]   ;The standard weight of a link is 1
 ask infrastructure 19                                                                   ;The final goal infrastructure 19 has specific links
